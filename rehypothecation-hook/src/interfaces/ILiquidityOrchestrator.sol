...
interface ILiquidityOrchestrator {
    ...
    struct PositionData {
        ...
        int24 tickLower;
        int24 tickUpper;
        uint256 reserveAmount0; // no longer encrypted
        uint256 reserveAmount1; // no longer encrypted
        uint256 aaveAmount0; // no longer encrypted
        uint256 aaveAmount1; // no longer encrypted
        uint256 totalLiquidity; // no longer encrypted
        uint8 reservePct;
        PositionState state;
    }
