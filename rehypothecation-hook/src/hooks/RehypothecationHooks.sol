...
contract RehypothecationHooks is BaseHook {
        ...
        )
    {
        ...
        if (
            (pos.reserveAmount0 <= withdrawn0 + tolerance) &&
            (pos.reserveAmount1 <= withdrawn1 + tolerance)
        ) {
            liqAmount0 = 0;
            liqAmount1 = 0;
        } else {
            liqAmount0 = pos.reserveAmount0 > withdrawn0
                ? pos.reserveAmount0 - withdrawn0
                : 0;
            liqAmount1 = pos.reserveAmount1 > withdrawn1
                ? pos.reserveAmount1 - withdrawn1
                : 0;
        }
