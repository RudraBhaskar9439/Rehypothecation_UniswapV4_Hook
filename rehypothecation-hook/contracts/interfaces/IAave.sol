...
interface IAave {
    ...
    /**
     * @dev Gets the normalized income for a specific asset
    ...
    /**
     * @dev Gets the normalized variable debt for a specific asset
     * @param asset The address of the asset
     * @return The normalized varibale index
     */
